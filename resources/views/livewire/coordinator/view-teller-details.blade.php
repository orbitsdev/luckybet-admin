<div class="p-6">
    <div class="flex items-center mb-6">
        ...
        <div>
            ...
            <div class="text-gray-500">Teller</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            <div class="mb-2 text-sm text-gray-500">Commission Rate</div>
            <div class="text-lg font-medium text-gray-900">
                @if(isset($record->commission) && isset($record->commission->rate))
                    {{ $record->commission->rate }} %
                @else
                    -
                @endif
            </div>
