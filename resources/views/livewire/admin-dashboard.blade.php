...
>
    ...
    <div class="flex flex-1 overflow-hidden bg-white pt-16" @click.self="sidebarOpen = false">
        ...
        <div class="lg:hidden fixed inset-y-0 left-0 transform transition-transform duration-300 ease-in-out z-50"
            ...
            <aside class="h-full w-64 overflow-y-auto bg-white shadow-xl">
        ...
        <div class="hidden lg:block fixed top-16 bottom-0 left-0 transition-transform duration-300 z-40" :class="{'translate-x-0': sidebarOpen && window.innerWidth >= 1024, '-translate-x-full': !sidebarOpen || window.innerWidth < 1024}">
            <aside class="h-full w-64 overflow-y-auto bg-white shadow-xl">
                <nav class="px-3 border-t-4 border-red-400 py-4">
                    <!-- Dashboard Link -->
                    <a href="#" class="group flex items-center px-5 py-3.5 rounded-lg font-bold text-base text-gray-700 nav-item active">
                    ...
                    <!-- Users Dropdown -->
                    <div class="space-y-1 mt-4">
                        <button @click="usersOpen = !usersOpen" class="group w-full flex items-center justify-between px-5 py-3.5 rounded-lg text-base text-gray-700 nav-item hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-200">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-3">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                                </svg>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 transform transition-transform duration-200" :class="{'rotate-180': usersOpen}">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                            </svg>
                        </button>
                        <div x-show="usersOpen" x-collapse>
                            <a href="#" class="block pl-12 pr-5 py-3 text-gray-600 hover:bg-red-50 rounded-lg transition-colors duration-300 ease-in-out">
                                Coordinators
                            </a>
                            <a href="#" class="block pl-12 pr-5 py-3 text-gray-600 hover:bg-red-50 rounded-lg transition-colors duration-300 ease-in-out">
                                Tellers
                    ...
                    <!-- Reports Dropdown -->
                    <div class="space-y-1 mt-4">
                        <button @click="reportsOpen = !reportsOpen" class="group w-full flex items-center justify-between px-5 py-3.5 rounded-lg text-base text-gray-700 nav-item hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-200">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-3">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />
                                </svg>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 transform transition-transform duration-200" :class="{'rotate-180': reportsOpen}">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                            </svg>
                        </button>
                        <div x-show="reportsOpen" x-collapse>
                            <a href="#" class="block pl-12 pr-5 py-3 text-gray-600 hover:bg-red-50 rounded-lg transition-colors duration-300 ease-in-out">
                                Coordinator Report
                            </a>
                            <a href="#" class="block pl-12 pr-5 py-3 text-gray-600 hover:bg-red-50 rounded-lg transition-colors duration-300 ease-in-out">
        ...
        <!-- Main Content -->
        <main class="flex-1 p-8 bg-white overflow-y-auto transition-all duration-300" :class="{'ml-0': !sidebarOpen || window.innerWidth < 1024, 'lg:ml-64': sidebarOpen && window.innerWidth >= 1024}">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aliquid provident excepturi velit, ullam doloremque nisi sit nulla incidunt inventore illo, similique minus. Quas deleniti sint error temporibus? Eum, voluptas?
            <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aliquid provident excepturi velit, ullam doloremque nisi sit nulla incidunt inventore illo, similique minus. Quas deleniti sint error temporibus? Eum, voluptas?</p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aliquid provident excepturi velit, ullam doloremque nisi sit nulla incidunt inventore illo, similique minus. Quas deleniti sint error temporibus? Eum, voluptas?
            <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aliquid provident excepturi velit, ullam doloremque nisi sit nulla incidunt inventore illo, similique minus. Quas deleniti sint error temporibus? Eum, voluptas?</p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aliquid provident excepturi velit, ullam doloremque nisi sit nulla incidunt inventore illo, similique minus. Quas deleniti sint error temporibus? Eum, voluptas?
            <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae aliquid provident excepturi velit, ullam doloremque nisi sit nulla incidunt inventore illo, similique minus. Quas deleniti sint error temporibus? Eum, voluptas?</p>
