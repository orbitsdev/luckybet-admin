        ...
        <div class="p-4 bg-white rounded-lg shadow-md">
            ...
            <div class="mb-6">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <button wire:click="resetFilters" class="inline-flex items-center px-3 py-1.5 bg-gray-100 border border-gray-300 rounded-md font-medium text-sm text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
