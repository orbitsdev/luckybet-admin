    ...
    <div class="container mx-auto px-4 py-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            <div>
                ...
                <p class="text-gray-600">View sales data for your tellers</p>
            </div>
        ...
        <div class="mb-4 bg-indigo-50 p-4 rounded-lg">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h2 class="text-xl font-semibold text-gray-800">Coordinator: {{ $coordinator->name }}</h2>
                    <p class="text-sm text-gray-600">Viewing all tellers under your management</p>
                </div>
            </div>
        </div>
        @endif
