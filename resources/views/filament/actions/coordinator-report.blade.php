                ...
                <tbody>
                    ...
                    @forelse ($coordinators as $coordinator)
                        ...
                        <tr class="border-t hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2">{{ number_format($sales, 2) }}</td>
                            <td class="px-4 py-2">{{ number_format($hits, 2) }}</td>
                            <td class="px-4 py-2">{{ number_format($gross, 2) }}</td>
                            <td class="px-4 py-2">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-4">No coordinators found.</td>
                        </tr>
                    @endforelse
                </tbody>
