...
class ListBetRatios extends Component implements HasForms, HasTable
{
     ...
     */
    public $total_bet_ratios = 0;
    public $total_active_bet_ratios = 0;
    public $total_inactive_bet_ratios = 0;
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                // Only show bet ratios for locations assigned to the coordinator
                BetRatio::query()
    ...
    #[On('bet-ratio-created')]
    #[On('bet-ratio-updated')]
    #[On('bet-ratio-deleted')]
